...
/// MikroTik OpenVPN server interface/binding (`/rest/interface/ovpn-server`).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
// ── PPP (used by OpenVPN, L2TP, PPTP, SSTP) ─────────────

/// MikroTik PPP secret / user account (`/rest/ppp/secret`).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// MikroTik PPP active connection (`/rest/ppp/active`).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// MikroTik PPP profile (`/rest/ppp/profile`).
#[derive(Debug, Clone, Serialize, Deserialize)]
