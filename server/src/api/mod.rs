...
pub fn router(state: AppState) -> Router {
    ...
    let protected_routes = Router::new()
        ...
        // OpenVPN Management
        .route("/openvpn/dashboard", get(openvpn::dashboard))
        ...
        .route(
            "/openvpn/clients/:name/export",
            get(openvpn::export_client_config),
        )
        // MikroTik PKI Certificates
        .route("/mikrotik/certificates", get(openvpn::list_certificates))
        // Tailscale
