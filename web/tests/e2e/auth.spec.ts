...
test.describe('Authentication', () => {
  test('login page loads correctly', async ({ page }) => {
    ...
    await expect(page.locator('text=Sign in to your network dashboard')).toBeVisible({ timeout: 15000 });
  ...
  test('login with wrong password shows error', async ({ page }) => {
    ...
    await expect(page.locator('text=Invalid password')).toBeVisible({ timeout: 10000 });
