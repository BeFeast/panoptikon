...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center mesh-card border-dashed px-5 py-7 text-center">
      <div className="mb-3 flex h-10 w-10 items-center justify-center mesh-card">
