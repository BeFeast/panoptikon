                ...
                {filtered === null ? (
                  Array.from({ length: 3 }).map((_, i) => (
                    <TableRow key={i} className="border-cyan-900/45">
                      <TableCell>
                        <Skeleton className="h-4 w-48 bg-cyan-950/35" />
                      </TableCell>
                      <TableCell>
                        <Skeleton className="h-4 w-32 bg-cyan-950/35" />
                      </TableCell>
                      <TableCell>
                        <Skeleton className="h-4 w-16 bg-cyan-950/35" />
                      </TableCell>
                      <TableCell>
                        <Skeleton className="h-4 w-20 bg-cyan-950/35" />
                      </TableCell>
                    </TableRow>
                  ))
                ) : filtered.length === 0 ? (
