      ...
      <div className="mx-auto max-w-5xl space-y-8 py-8">
          ...
          <Card className="border-slate-800 bg-slate-900">
            <CardContent className="py-3">
              ...
              <p className="text-2xl font-semibold text-white">
                {statsData ? statsData.total_blocked_domains.toLocaleString() : <Skeleton className="h-7 w-20 bg-slate-800" />}
              </p>
            </CardContent>
          </Card>
          <Card className="border-slate-800 bg-slate-900">
            <CardContent className="py-3">
              ...
              <p className="text-2xl font-semibold text-white">
                {statsData ? `${statsData.enabled_blocklists} / ${statsData.total_blocklists}` : <Skeleton className="h-7 w-16 bg-slate-800" />}
              </p>
            </CardContent>
          </Card>
          <Card className="border-slate-800 bg-slate-900">
            <CardContent className="py-3">
              ...
              <p className="text-2xl font-semibold text-white">
                {statsData ? statsData.whitelist_count : <Skeleton className="h-7 w-10 bg-slate-800" />}
              </p>
            </CardContent>
          </Card>
          <Card className="border-slate-800 bg-slate-900">
            <CardContent className="py-3">
              ...
              <p className="text-sm font-medium text-white">
                {statsData ? formatDate(statsData.last_updated) : <Skeleton className="h-5 w-32 bg-slate-800" />}
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="blocklists">
          <TabsList className="border-slate-800 bg-slate-900">
            ...
            <TabsTrigger value="overrides" className="data-[state=active]:bg-slate-800">
              Overrides
            </TabsTrigger>
          </TabsList>
                  ...
                  <TableBody>
                    {filteredLists === null ? (
                      ...
                      filteredLists.map((bl) => (
                        <TableRow key={bl.id} className="border-slate-800 hover:bg-slate-800/30">
                          <TableCell>
                  ...
                  <TableBody>
                    {filteredOverrides === null ? (
                      ...
                      filteredOverrides.map((ovr) => (
                        <TableRow key={ovr.id} className="border-slate-800 hover:bg-slate-800/30">
          ...
          <DialogContent className="border-slate-800 bg-slate-900 sm:max-w-2xl max-h-[80vh]">
            ...
            <div className="space-y-3">
              ...
              {unboundConfig === null ? (
                ...
                <pre className="max-h-96 overflow-auto rounded-md border border-slate-800 bg-slate-950 p-4 text-xs text-slate-300 font-mono">
                  {unboundConfig}
                </pre>
              )}
              <div className="flex justify-end">
